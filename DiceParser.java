...
public class DiceParser{
	 ...
	 * dtail XXXX| FA(die,bonus,N) dtail dtail::= & dice | <nothing> die::= (N)? dN
	 * bonus::= + N | -N
	 **/
	...
	/**
	 * dice::= die (bonus?) dtail XXXX| FA(die,bonus,N) dtail
	 */
	...
	private static DieRoll parseDiceInner(StringStream ss){
		/*
		 * if(checkAndEat("FA(")) { DieRoll d=parseFA(ss); if(d==null) return null;
